...
public class SourceDestination {
	 ...
	 * @param target_type			IPv4Address/MACAddress | LogicalPort | LogicalSwitch | NSGroup | IPSet/MACSet 
	 * @param target_id				objectId | IPAddress(e.g. 192.168.1.1)
	 */
	public SourceDestination(String target_display_name,
