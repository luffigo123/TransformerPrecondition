...
public class DHCPRelayServiceProCon {
...
//		dhcpRelayProfileService = new DHCPRelayProfileService();
	...
	public DHCPRelayServer getDHCPRelayServer(String dhcpRelayServiceName, String dhcpRelayProfileId){
...
//		String dhcpRelayProfileID = this.dhcpRelayProfileService.getObjectId(this.dhcpRelayProfileService.display_name);
		DHCPRelayServer dhcpRelayServer = new DHCPRelayServer(dhcpRelayServiceName, dhcpRelayServiceName, dhcpRelayProfileId, "DhcpRelayService");
